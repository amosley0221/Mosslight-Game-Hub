import type { Asset, HubData, Project, Settings } from './types';
import { DEFAULT_MODELS } from './constants';
import { A, D, H, T, now, uid } from './util';

// First-run demo library, ported from the design prototype (hub-core.js → seed()).
...
/** Fill in fields older saves (or the prototype seed) may be missing. */
...
export const seedData = (): HubData => ({ ...seedProjects(), assets: seedAssets() });
